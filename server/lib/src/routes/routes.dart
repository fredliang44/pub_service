...
AngelConfigurer configureServer(FileSystem fileSystem) {
  return (Angel app) async {
    ...
    app.get('/', (RequestContext req, ResponseContext res) => res.render('hello'));

    app.group('/service', (service) {
      service.get('/nlp', (RequestContext req, ResponseContext res) =>
          {
            "test":"data"
          }
        );
    ...
    // The `CachingVirtualDirectory` variant of `VirtualDirectory` also sendsr `Cache-Control` headers.
    //
